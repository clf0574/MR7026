...
//组合按键
#define KEY_DOWN_SETUP		KEY_SETUP_DOWN
#define KEY_UP_SETUP		KEY_SETUP_UP
#define KEY_LONG_SETUP		KEY_SETUP_LONG
...
*/
#define KEY_FILTER_TIME   12
#define KEY_LONG_TIME     800			/* 单位10ms， 持续1秒，认为长按事件 */
