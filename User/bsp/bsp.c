...
//extern void AppTask_KeyScan(void);
//extern void AppTask_LedToggle(void);
...
void bsp_Init(void)
{
	...
	*/
	...
	bsp_InitLed(); 			/* 初始LED指示灯端口 */
  	bsp_InitUart(1); 			/* 初始化串口 */
	bsp_InitKey();      		/* 初始化按键 */
	bsp_EepromInit();		//初始化eeprom
	
	#ifdef USE_A7139
	bsp_InitRF(1);			//初始化A7139
	#else
	bsp_InitCC1101();		//初始化CC1101
	#endif
